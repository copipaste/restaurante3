          ...
          <div class="grid lg:grid-cols-4 gap-y-6">
            ...
            <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-between p-4">
                    {{-- <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="px-4 py-2 bg-green-600 text-green-50">Order Now</button> --}}
                                                        ...
                                                        <form action="{{ route('menu.update',$product) }}" id="product-form" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                                                            ...
                                                            <div class="grid gap-4 mb-4 grid-cols-2">
                                                                ...
                                                                <div class="col-span-2">
                                                                    <label for="descripcion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Description</label>
                                                                ...
                                                                <div class="relative flex items-center max-w-[12rem]">
                                                                    <button type="button" id="decrement-button{{$product->id}}" data-input-counter-decrement="{{$product->id}}" class="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                                                                     ...
                                                                     {{--este es el input--}} <input type="text" id="cantidad{{$product->id}}" name ="cantidad" data-input-counter aria-describedby="helper-text-explanation" class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0" required>
                                                                    <button type="button" id="increment-button{{$product->id}}" data-input-counter-increment="{{$product->id}}" class="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
